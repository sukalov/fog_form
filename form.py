...
def rus_comment():
    if request.args:
        ...
        ''', (sex,age,land1,land2,language,languages,email,langcomment,given_order,T011,T012,T021,T022,T031,T032,T041,T042,T051,T052,T061,T062,T071,T072,T081,T082,T091,T092,T101,T102,T111,T112,T121,T122,T131,T132,T141,T142,T151,T152,T161,T162,finalcomment))
        conn.commit()
        cur.close()
        conn.close()
